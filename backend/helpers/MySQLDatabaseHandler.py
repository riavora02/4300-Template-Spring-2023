...
class Webtoon(db.Model):
    ...
    released_date = db.Column(db.String, nullable=False)
    url = db.Column(db.String, nullable=False)
    cover = db.Column(db.String, nullable=False)
    likes = db.Column(db.Integer, nullable=False)
    written_by = db.Column(db.String, nullable=False)
    art_by = db.Column(db.String, nullable=False)
    adapted_by = db.Column(db.String, nullable=False)
    original_work_by = db.Column(db.String, nullable=False)
    assisted_by = db.Column(db.String, nullable=False)
